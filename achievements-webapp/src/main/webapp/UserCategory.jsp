		...
		<div id="context-1" class="ui-context">
			<div class="context">
				<a href="javascript:;" class="close" onclick="return CharSelect.close(this);"></a>
					<div class="context-user"><strong>Бебълсчето</strong><span>#984</span></div>
					<div class="context-links">
					<a href="/achievements-webapp/sc2/en/profile/5716947/1/Sunstriderr/" title="Profile" rel="np" class="icon-profile link-first">
						<span class="context-icon"></span>Profile
					</a>
					<a href="/achievements-webapp/sc2/en/search?f=post&amp;a=Sunstriderr%23984&amp;sort=time" title="View my posts" rel="np" class="icon-posts link-last">
